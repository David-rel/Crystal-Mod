...
public class TanzaniteItem extends Item {
    public TanzaniteItem(Properties pProperties) {
        super(pProperties);
    }
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component>
        ...
        if(Screen.hasShiftDown()){
            pTooltipComponent.add(new TranslatableComponent("tooltip.crystal_mod.tanzanite"));
        }else{
            pTooltipComponent.add(new TranslatableComponent("tooltip.crystal_mod.tanzanite_shift"));
